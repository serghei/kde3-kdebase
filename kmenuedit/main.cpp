...
static const KCmdLineOptions options[] = {{"+[menu]", I18N_NOOP("Sub menu to pre-select"), 0},
...
{
    KAboutData aboutData("kmenuedit", I18N_NOOP("KDE Menu Editor"), version, description, KAboutData::License_GPL,
