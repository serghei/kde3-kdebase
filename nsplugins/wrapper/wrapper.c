...
static NPError MyNPP_New(NPMIMEType pluginType, NPP instance, uint16 mode, int16 argc, char *argn[], char *argv[], NPSavedData *saved)
{
    NPError err;
    int n;
...
static NPError MyNPP_Destroy(NPP instance, NPSavedData **save)
{
    NPError err;
...
static NPError MyNPP_SetWindow(NPP instance, NPWindow *window)
{
    NPError err;
...
static NPError MyNPP_NewStream(NPP instance, NPMIMEType type, NPStream *stream, NPBool seekable, uint16 *stype)
{
    NPError err;
...
static NPError MyNPP_DestroyStream(NPP instance, NPStream *stream, NPReason reason)
{
    NPError err;
...
static int32 MyNPP_WriteReady(NPP instance, NPStream *stream)
{
    int32 ret;
...
static int32 MyNPP_Write(NPP instance, NPStream *stream, int32 offset, int32 len, void *buffer)
{
    int32 ret;
...
static void MyNPP_StreamAsFile(NPP instance, NPStream *stream, const char *fname)
{
...
static void MyNPP_Print(NPP instance, NPPrint *platformPrint)
{
...
static int16 MyNPP_HandleEvent(NPP instance, void *event)
{
    int16 ret;
...
static void MyNPP_URLNotify(NPP instance, const char *url, NPReason reason, void *notifyData)
{
...
static NPError MyNPP_GetValue(void *instance, NPPVariable variable, void *value)
{
    NPError err;
...
static NPError MyNPP_SetValue(void *instance, NPNVariable variable, void *value)
{
    NPError err;
...
static NPError MyNPN_GetURLNotify(NPP instance, const char *url, const char *target, void *notifyData)
{
    NPError err;
...
static NPError MyNPN_GetURL(NPP instance, const char *url, const char *target)
{
    NPError err;
...
static NPError MyNPN_PostURLNotify(NPP instance, const char *url, const char *target, uint32 len, const char *buf, NPBool file, void *notifyData)
{
    NPError err;
...
static NPError MyNPN_PostURL(NPP instance, const char *url, const char *target, uint32 len, const char *buf, NPBool file)
{
    NPError err;
...
static NPError MyNPN_RequestRead(NPStream *stream, NPByteRange *rangeList)
{
    NPError err;
...
static NPError MyNPN_NewStream(NPP instance, NPMIMEType type, const char *target, NPStream **stream)
{
    NPError err;
...
static int32 MyNPN_Write(NPP instance, NPStream *stream, int32 len, void *buffer)
{
    int32 ret;
...
static NPError MyNPN_DestroyStream(NPP instance, NPStream *stream, NPReason reason)
{
    NPError err;
...
static void MyNPN_Status(NPP instance, const char *message)
{
...
static const char *MyNPN_UserAgent(NPP instance)
{
    const char *ret;
...
static void *MyNPN_MemAlloc(uint32 size)
{
    void *ret;
...
static void MyNPN_MemFree(void *ptr)
{
...
static uint32 MyNPN_MemFlush(uint32 size)
{
    uint ret;
...
static void MyNPN_ReloadPlugins(NPBool reloadPages)
{
...
static JRIEnv *MyNPN_GetJavaEnv(void)
{
    JRIEnv *ret;
...
static jref MyNPN_GetJavaPeer(NPP instance)
{
    jref ret;
...
static NPError MyNPN_GetValue(NPP instance, NPNVariable variable, void *value)
{
    NPError ret;
...
static NPError MyNPN_SetValue(NPP instance, NPPVariable variable, void *value)
{
    NPError ret;
...
static void MyNPN_InvalidateRect(NPP instance, NPRect *invalidRect)
{
...
static void MyNPN_InvalidateRegion(NPP instance, NPRegion invalidRegion)
{
...
static void MyNPN_ForceRedraw(NPP instance)
{
