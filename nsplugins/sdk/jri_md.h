...
#define jlong_UDIVMOD(qp, rp, a, b) (*(qp) = ((julong)(a) / (b)), *(rp) = ((julong)(a) % (b)))
...
#define jlong_AND(r, a, b) ((r).lo = (a).lo & (b).lo, (r).hi = (a).hi & (b).hi)
#define jlong_OR(r, a, b) ((r).lo = (a).lo | (b).lo, (r).hi = (a).hi | (b).hi)
#define jlong_XOR(r, a, b) ((r).lo = (a).lo ^ (b).lo, (r).hi = (a).hi ^ (b).hi)
#define jlong_OR2(r, a) ((r).lo = (r).lo | (a).lo, (r).hi = (r).hi | (a).hi)
#define jlong_NOT(r, a) ((r).lo = ~(a).lo, (r).hi = ~(a).hi)

#define jlong_NEG(r, a) ((r).lo = -(int32)(a).lo, (r).hi = -(int32)(a).hi - ((r).lo != 0))
...
extern JRI_PUBLIC_API(void) jlong_udivmod(julong *qp, julong *rp, julong a, julong b);
...
#define JRI_GET_INT64(_t, _addr) (((_t).x[0] = ((jint *)(_addr))[0]), ((_t).x[1] = ((jint *)(_addr))[1]), (_t).l)
#define JRI_SET_INT64(_t, _addr, _v) ((_t).l = (_v), ((jint *)(_addr))[0] = (_t).x[0], ((jint *)(_addr))[1] = (_t).x[1])
#else
...
#define JRI_GET_DOUBLE(_t, _addr) (((_t).x[0] = ((jint *)(_addr))[0]), ((_t).x[1] = ((jint *)(_addr))[1]), (_t).d)
#define JRI_SET_DOUBLE(_t, _addr, _v) ((_t).d = (_v), ((jint *)(_addr))[0] = (_t).x[0], ((jint *)(_addr))[1] = (_t).x[1])
#else
