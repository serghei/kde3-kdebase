...
class Action_list_widget : public Action_list_widget_ui {
    Q_OBJECT
public:
...
protected:
    Action_list_item *create_listview_item(Action *action_P, QListView *parent1_P, QListViewItem *parent2_P, QListViewItem *after_P, bool copy_P);
    void edit_listview_item(Action_list_item *item_P);
    enum type_t
    {
        TYPE_COMMAND_URL_ACTION,
        TYPE_MENUENTRY_ACTION,
        TYPE_DCOP_ACTION,
        TYPE_KEYBOARD_INPUT_ACTION,
        TYPE_ACTIVATE_WINDOW_ACTION
    };
protected slots:
...
class Action_list_item : public QListViewItem {
public:
...
class Command_url_action_dialog : public KDialogBase, public Action_dialog {
    Q_OBJECT
public:
...
class Menuentry_action_dialog : public KDialogBase, public Action_dialog {
    Q_OBJECT
public:
...
class Dcop_action_dialog : public KDialogBase, public Action_dialog {
    Q_OBJECT
public:
...
class Keyboard_input_action_dialog : public KDialogBase, public Action_dialog {
    Q_OBJECT
public:
...
class Activate_window_action_dialog : public KDialogBase, public Action_dialog {
    Q_OBJECT
public:
...
inline Action_list_item::Action_list_item(QListView *parent_P, Action *action_P) : QListViewItem(parent_P), _action(action_P)
{
}

inline Action_list_item::Action_list_item(QListViewItem *parent_P, Action *action_P) : QListViewItem(parent_P), _action(action_P)
{
}

inline Action_list_item::Action_list_item(QListView *parent_P, QListViewItem *after_P, Action *action_P)
    : QListViewItem(parent_P, after_P), _action(action_P)
{
}

inline Action_list_item::Action_list_item(QListViewItem *parent_P, QListViewItem *after_P, Action *action_P)
    : QListViewItem(parent_P, after_P), _action(action_P)
{
}

inline Action *Action_list_item::action() const
{
    return _action;
}

inline void Action_list_item::set_action(Action *action_P)
{
    delete _action;
    _action = action_P;
}
...
inline Action_dialog::~Action_dialog()
{
}
