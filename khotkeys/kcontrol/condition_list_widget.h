...
class Condition_list_widget : public Condition_list_widget_ui {
    Q_OBJECT
public:
...
protected:
    Condition_list_item *create_listview_item(Condition *condition_P, QListView *parent1_P, Condition_list_item *parent2_P, QListViewItem *after_P,
                                              bool copy_P);
    void edit_listview_item(Condition_list_item *item_P);
    enum type_t
    {
        TYPE_ACTIVE_WINDOW,
        TYPE_EXISTING_WINDOW,
        TYPE_NOT,
        TYPE_AND,
        TYPE_OR
    };
...
private:
    void insert_listview_items(const Condition_list_base *parent_P, QListView *parent1_P, Condition_list_item *parent2_P);
...
class Condition_list_item : public QListViewItem {
public:
    ...
    Condition_list_item(QListViewItem *parent_P, QListViewItem *after_P, Condition *condition_P);
...
class Active_window_condition_dialog : public KDialogBase, public Condition_dialog {
    Q_OBJECT
public:
...
class Existing_window_condition_dialog : public KDialogBase, public Condition_dialog {
    Q_OBJECT
public:
...
inline Condition_list_item::Condition_list_item(QListView *parent_P, Condition *condition_P) : QListViewItem(parent_P), _condition(condition_P)
{
}
...
inline Condition_list_item::Condition_list_item(QListView *parent_P, QListViewItem *after_P, Condition *condition_P)
    : QListViewItem(parent_P, after_P), _condition(condition_P)
{
}

inline Condition_list_item::Condition_list_item(QListViewItem *parent_P, QListViewItem *after_P, Condition *condition_P)
    : QListViewItem(parent_P, after_P), _condition(condition_P)
{
}

inline Condition *Condition_list_item::condition() const
{
    return _condition;
}

inline void Condition_list_item::set_condition(Condition *condition_P)
{
...
inline Condition_dialog::~Condition_dialog()
{
}
