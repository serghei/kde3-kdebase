...
General_settings_tab::General_settings_tab(QWidget *parent_P, const char *name_P) : General_settings_tab_ui(parent_P, name_P)
{
    // KHotKeys::Module::changed()
    connect(disable_daemon_checkbox, SIGNAL(clicked()), module, SLOT(changed()));
}
