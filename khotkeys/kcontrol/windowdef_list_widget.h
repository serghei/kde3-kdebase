...
class Windowdef_list_widget : public Windowdef_list_widget_ui {
    Q_OBJECT
public:
...
protected:
    Windowdef_list_item *create_listview_item(Windowdef *window_P, QListView *parent1_P, QListViewItem *parent2_P, QListViewItem *after_P,
                                              bool copy_P);
    void edit_listview_item(Windowdef_list_item *item_P);
    enum type_t
    {
        TYPE_WINDOWDEF_SIMPLE
    };
protected slots:
...
class Windowdef_list_item : public QListViewItem {
public:
...
class Windowdef_simple_dialog : public KDialogBase, public Windowdef_dialog {
    Q_OBJECT
public:
...
inline void Windowdef_list_widget::set_autodetect(QObject *obj_P, const char *slot_P)
{
...
inline Windowdef_list_item::Windowdef_list_item(QListView *parent_P, Windowdef *window_P) : QListViewItem(parent_P), _window(window_P)
{
}

inline Windowdef_list_item::Windowdef_list_item(QListViewItem *parent_P, Windowdef *window_P) : QListViewItem(parent_P), _window(window_P)
{
}

inline Windowdef_list_item::Windowdef_list_item(QListView *parent_P, QListViewItem *after_P, Windowdef *window_P)
    : QListViewItem(parent_P, after_P), _window(window_P)
{
}

inline Windowdef_list_item::Windowdef_list_item(QListViewItem *parent_P, QListViewItem *after_P, Windowdef *window_P)
    : QListViewItem(parent_P, after_P), _window(window_P)
{
}

inline Windowdef *Windowdef_list_item::window() const
{
    return _window;
}

inline void Windowdef_list_item::set_window(Windowdef *window_P)
{
    delete _window;
    _window = window_P;
}
...
inline Windowdef_dialog::~Windowdef_dialog()
{
}
