...
class Actions_listview_widget : public Actions_listview_widget_ui {
    Q_OBJECT
public:
...
private:
    ...
    void build_up_recursively(Action_data_group *parent_P, Action_listview_item *item_parent_P);
...
class Actions_listview : public KHListView {
    Q_OBJECT
public:
...
class Action_listview_item : public QListViewItem {
public:
...
inline Action_listview_item *Actions_listview_widget::current_action() const
{
    return saved_current_item;
}

inline Action_data_base *Actions_listview_widget::current_action_data() const
{
    return current_action() != NULL ? current_action()->data() : NULL;
}

inline void Actions_listview_widget::clear()
{
...
inline Actions_listview_widget *Actions_listview::widget()
{
    return _widget;
}
...
inline Action_listview_item::Action_listview_item(QListView *parent_P, QListViewItem *after_P, Action_data_base *data_P)
...
inline Action_listview_item::Action_listview_item(QListViewItem *parent_P, QListViewItem *after_P, Action_data_base *data_P)
    : QListViewItem(parent_P, after_P), _data(data_P)
{
    if(dynamic_cast< Action_data_group * >(data_P))
        setExpandable(true);
...
inline Action_data_base *Action_listview_item::data() const
{
    return _data;
}

inline void Action_listview_item::set_data(Action_data_base *data_P)
{
    _data = data_P;
}
