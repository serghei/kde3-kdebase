...
Menuentry_widget::Menuentry_widget(QWidget *parent_P, const char *name_P) : Menuentry_widget_ui(parent_P, name_P)
{
    clear_data();
    // KHotKeys::Module::changed()
    connect(menuentry_lineedit, SIGNAL(textChanged(const QString &)), module, SLOT(changed()));
}
