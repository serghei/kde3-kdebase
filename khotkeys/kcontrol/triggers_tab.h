...
class Triggers_tab : public Triggers_tab_ui {
    Q_OBJECT
public:
...
protected:
    Trigger_list_item *create_listview_item(Trigger *trigger_P, QListView *parent_P, QListViewItem *after_P, bool copy_P);
    void edit_listview_item(Trigger_list_item *item_P);
    Trigger_list_item *selected_item;
    enum type_t
    {
        TYPE_SHORTCUT_TRIGGER,
        TYPE_GESTURE_TRIGGER,
        TYPE_WINDOW_TRIGGER,
        TYPE_VOICE_TRIGGER
    };
protected slots:
...
class Trigger_list_item : public QListViewItem {
public:
...
class Shortcut_trigger_widget : public QWidget {
    Q_OBJECT
public:
...
class Shortcut_trigger_dialog : public KDialogBase, public Trigger_dialog {
    Q_OBJECT
public:
...
class Window_trigger_dialog : public KDialogBase, public Trigger_dialog {
    Q_OBJECT
public:
...
class Gesture_trigger_dialog : public KDialogBase, public Trigger_dialog {
    Q_OBJECT
public:
...
class Voice_trigger_dialog : public KDialogBase, public Trigger_dialog {
    Q_OBJECT
public:
...
inline Trigger_list_item::Trigger_list_item(QListView *parent_P, Trigger *trigger_P) : QListViewItem(parent_P), _trigger(trigger_P)
{
}

inline Trigger_list_item::Trigger_list_item(QListView *parent_P, QListViewItem *after_P, Trigger *trigger_P)
    : QListViewItem(parent_P, after_P), _trigger(trigger_P)
{
}

inline Trigger_list_item::~Trigger_list_item()
...
inline Trigger *Trigger_list_item::trigger() const
{
    return _trigger;
}

inline void Trigger_list_item::set_trigger(Trigger *trigger_P)
{
    delete _trigger;
    _trigger = trigger_P;
}
...
inline Trigger_dialog::~Trigger_dialog()
{
}
