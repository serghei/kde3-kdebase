...
class KDE_EXPORT Trigger_list : public QPtrList< Trigger > {
public:
...
class KDE_EXPORT Shortcut_trigger : public Trigger, public Kbd_receiver {
...
class KDE_EXPORT Window_trigger : public QObject, public Trigger {
    Q_OBJECT
    typedef Trigger base;
...
class KDE_EXPORT Gesture_trigger : public QObject, public Trigger {
    Q_OBJECT
    typedef Trigger base;
...
class KDE_EXPORT Voice_trigger : public QObject, public Trigger {
    Q_OBJECT
    typedef Trigger base;
...
inline Trigger::Trigger(Action_data *data_P) : data(data_P)
{
}

inline Trigger::Trigger(KConfig &, Action_data *data_P) : data(data_P)
{
}
...
inline Trigger_list::Trigger_list(const QString &comment_P) : QPtrList< Trigger >(), _comment(comment_P)
{
    setAutoDelete(true);
}

inline const QString &Trigger_list::comment() const
{
    return _comment;
}
...
inline const KShortcut &Shortcut_trigger::shortcut() const
{
    return _shortcut;
}
...
inline Window_trigger::Window_trigger(Action_data *data_P, Windowdef_list *windows_P, int window_actions_P)
    : Trigger(data_P), _windows(windows_P), window_actions(window_actions_P), last_active_window(None), active(false)
{
    init();
}

inline const Windowdef_list *Window_trigger::windows() const
{
    return _windows;
}

inline bool Window_trigger::triggers_on(window_action_t w_action_P) const
{
...
inline const QString &Gesture_trigger::gesturecode() const
{
    return _gesturecode;
}

// Voice_trigger
inline const QString &Voice_trigger::voicecode() const
{
    return _voicecode;
}

inline VoiceSignature Voice_trigger::voicesignature(int ech) const
{
