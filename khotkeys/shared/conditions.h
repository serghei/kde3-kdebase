...
class KDE_EXPORT Condition_list_base : public Condition,
                                       public QPtrList< Condition > // inheritance ?
{
    typedef Condition base;

public:
    Condition_list_base(Condition_list_base *parent_P);
    Condition_list_base(const QPtrList< Condition > &children_P, Condition_list_base *parent_P);
...
class KDE_EXPORT Condition_list : public Condition_list_base {
...
class KDE_EXPORT Active_window_condition : public QObject, public Condition {
    Q_OBJECT
    typedef Condition base;
...
class KDE_EXPORT Existing_window_condition : public QObject, public Condition {
    Q_OBJECT
    typedef Condition base;
...
class KDE_EXPORT Not_condition : public Condition_list_base {
    typedef Condition_list_base base;
...
class KDE_EXPORT And_condition : public Condition_list_base {
    typedef Condition_list_base base;
...
class KDE_EXPORT Or_condition : public Condition_list_base {
    typedef Condition_list_base base;
...
inline const Condition_list_base *Condition::parent() const
{
    return _parent;
}

inline Condition_list_base *Condition::parent()
{
    return _parent;
}
...
inline Condition_list_base::Condition_list_base(Condition_list_base *parent_P) : Condition(parent_P), QPtrList< Condition >()
{
}

inline Condition_list_base::Condition_list_base(const QPtrList< Condition > &children_P, Condition_list_base *parent_P)
...
inline Condition_list::Condition_list(const QString &comment_P, Action_data_base *data_P)
    : Condition_list_base(NULL), _comment(comment_P), data(data_P)
{
}

inline const QString &Condition_list::comment() const
{
    return _comment;
}
...
inline Active_window_condition::Active_window_condition(Windowdef_list *window_P, Condition_list_base *parent_P)
...
inline const Windowdef_list *Active_window_condition::window() const
{
    return _window;
}
...
inline Existing_window_condition::Existing_window_condition(Windowdef_list *window_P, Condition_list_base *parent_P)
...
inline const Windowdef_list *Existing_window_condition::window() const
{
    return _window;
}
...
inline Not_condition::Not_condition(Condition_list_base *parent_P) : Condition_list_base(parent_P)
{
}

inline const Condition *Not_condition::condition() const
{
    return getFirst();
}
...
inline And_condition::And_condition(Condition_list_base *parent_P) : Condition_list_base(parent_P)
{
}

// Or_condition

inline Or_condition::Or_condition(Condition_list_base *parent_P) : Condition_list_base(parent_P)
{
}
