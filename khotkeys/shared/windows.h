...
const int SUPPORTED_WINDOW_TYPES_MASK = NET::NormalMask | NET::DesktopMask | NET::DockMask | NET::ToolbarMask | NET::MenuMask | NET::DialogMask
                                        | NET::OverrideMask | NET::TopMenuMask | NET::UtilityMask | NET::SplashMask;

class Windowdef_list;
/*class Action_data_base;*/

class KDE_EXPORT Windows : public QObject {
    Q_OBJECT
public:
...
class KDE_EXPORT Windowdef_list : public QPtrList< Windowdef > {
public:
...
public:
    ...
    Windowdef_simple(const QString &comment_P, const QString &title_P, substr_type_t title_type_P, const QString &wclass_P,
                     substr_type_t wclass_type_P, const QString &role_P, substr_type_t role_type_P, int window_types_P);
...
inline Windowdef::Windowdef(const QString &comment_P) : _comment(comment_P)
{
}

inline const QString &Windowdef::comment() const
{
    return _comment;
}

inline Windowdef::~Windowdef()
{
}

// Windowdef_list

inline Windowdef_list::Windowdef_list(const QString &comment_P) : QPtrList< Windowdef >(), _comment(comment_P)
{
    setAutoDelete(true);
}

inline const QString &Windowdef_list::comment() const
{
    return _comment;
}
...
inline const QString &Windowdef_simple::title() const
{
    return _title;
}

inline Windowdef_simple::substr_type_t Windowdef_simple::title_match_type() const
{
    return title_type;
}

inline const QString &Windowdef_simple::wclass() const
{
    return _wclass;
}

inline Windowdef_simple::substr_type_t Windowdef_simple::wclass_match_type() const
{
    return wclass_type;
}

inline const QString &Windowdef_simple::role() const
{
    return _role;
}

inline Windowdef_simple::substr_type_t Windowdef_simple::role_match_type() const
{
    return role_type;
}

inline int Windowdef_simple::window_types() const
{
    return _window_types;
}

inline bool Windowdef_simple::type_match(window_type_t type_P) const
{
    return window_types() & type_P;
}

inline bool Windowdef_simple::type_match(NET::WindowType type_P) const
{
