...
static KCmdLineOptions options[] = {{"d <printer-name>", I18N_NOOP("The printer for which jobs are requested"), 0},
...
{
    KAboutData aboutData("kjobviewer", I18N_NOOP("KJobViewer"), "0.1", I18N_NOOP("A print job viewer"), KAboutData::License_GPL,
