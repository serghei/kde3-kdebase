...
static const char description[] = I18N_NOOP("A small fax utility to be used with kdeprint.");
...
int main(int argc, char *argv[])
{
    ...
    KAboutData aboutData("kdeprintfax", I18N_NOOP("KdeprintFax"), "1.0", description, KAboutData::License_GPL, "(c), 2001 Michael Goffioul", 0,
