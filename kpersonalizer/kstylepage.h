...
private:
    ...
    bool kde_hc_exist, kde_def_exist, kde_keramik_exist, kde_light_exist, cde_exist, win_exist, platinum_exist, kde_plastik_exist;

    // kwin-style-existence
    bool kwin_keramik_exist, kwin_default_exist, kwin_system_exist, kwin_win_exist, kwin_cde_exist, kwin_quartz_exist, kwin_plastik_exist;
