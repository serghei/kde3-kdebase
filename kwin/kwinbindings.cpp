#ifndef NOSLOTS
#define DEF2(name, descr, key3, key4, fnSlot) keys->insert(name, i18n(descr), QString::null, key3, key4, this, SLOT(fnSlot))
#define DEF(name, key3, key4, fnSlot) keys->insert(name, i18n(name), QString::null, key3, key4, this, SLOT(fnSlot))
#else
#define DEF2(name, descr, key3, key4, fnSlot) keys->insert(name, i18n(descr), QString::null, key3, key4)
...
DEF2("Window Close", I18N_NOOP("Close Window"), ALT + Qt::Key_F4, "Alt+Escape;Alt+F4", slotWindowClose());
DEF2("Window Maximize", I18N_NOOP("Maximize Window"), 0, WIN + Qt::Key_Plus, slotWindowMaximize());
DEF2("Window Maximize Vertical", I18N_NOOP("Maximize Window Vertically"), 0, WIN + Qt::Key_Bar, slotWindowMaximizeVertical());
DEF2("Window Maximize Horizontal", I18N_NOOP("Maximize Window Horizontally"), 0, WIN + Qt::Key_Equal, slotWindowMaximizeHorizontal());
DEF2("Window Minimize", I18N_NOOP("Minimize Window"), 0, WIN + Qt::Key_Minus, slotWindowMinimize());
DEF2("Window Shade", I18N_NOOP("Shade Window"), 0, WIN + Qt::Key_Underscore, slotWindowShade());
DEF2("Window Move", I18N_NOOP("Move Window"), 0, 0, slotWindowMove());
DEF2("Window Resize", I18N_NOOP("Resize Window"), 0, 0, slotWindowResize());
DEF2("Window Raise", I18N_NOOP("Raise Window"), 0, 0, slotWindowRaise());
DEF2("Window Lower", I18N_NOOP("Lower Window"), 0, 0, slotWindowLower());
DEF(I18N_NOOP("Toggle Window Raise/Lower"), 0, 0, slotWindowRaiseOrLower());
DEF2("Window Fullscreen", I18N_NOOP("Make Window Fullscreen"), 0, 0, slotWindowFullScreen());
