...
KDEDefaultConfig::KDEDefaultConfig(KConfig *conf, QWidget *parent) : QObject(parent)
{
    ...
    QWhatsThis::add(cbShowStipple, i18n("When selected, active titlebars are drawn "
    ...
    QWhatsThis::add(cbShowGrabBar, i18n("When selected, decorations are drawn with a \"grab bar\" "
    ...
    if(highcolor)
    {
        ...
        QWhatsThis::add(cbUseGradients, i18n("When selected, decorations are drawn with gradients "
    ...
    connect(cbShowStipple, SIGNAL(clicked()), this, SLOT(slotSelectionChanged()));
    connect(cbShowGrabBar, SIGNAL(clicked()), this, SLOT(slotSelectionChanged()));
    if(highcolor)
        connect(cbUseGradients, SIGNAL(clicked()), this, SLOT(slotSelectionChanged()));
