...
class KDecorationPreview : public QWidget {
    Q_OBJECT
public:
...
class KDecorationPreviewBridge : public KDecorationBridge {
public:
...
class KDecorationPreviewOptions : public KDecorationOptions {
public:
...
class KDecorationPreviewPlugins : public KDecorationPlugins {
public:
    KDecorationPreviewPlugins(KConfig *cfg);
    virtual bool provides(Requirement);
};

inline KDecorationPreviewPlugins::KDecorationPreviewPlugins(KConfig *cfg) : KDecorationPlugins(cfg)
{
}
