...
RulesWidget::RulesWidget(QWidget *parent, const char *name) : RulesWidgetBase(parent, name), detect_dlg(NULL)
{
    QString enableDesc = i18n("Enable this checkbox to alter this window property for the specified window(s).");
...
static const Rules::SetRule combo_to_set_rule[] = {(Rules::SetRule)Rules::DontAffect, (Rules::SetRule)Rules::Apply,
                                                   (Rules::SetRule)Rules::Remember,   (Rules::SetRule)Rules::Force,
                                                   (Rules::SetRule)Rules::ApplyNow,   (Rules::SetRule)Rules::ForceTemporarily};
...
static const Rules::ForceRule combo_to_force_rule[] = {(Rules::ForceRule)Rules::DontAffect, (Rules::ForceRule)Rules::Force,
...
static Placement::Policy comboToPlacement(int val)
{
    static const Placement::Policy conv[] = {
        Placement::Default, Placement::NoPlacement,  Placement::Smart,      Placement::Maximizing,  Placement::Cascade, Placement::Centered,
        Placement::Random,  Placement::ZeroCornered, Placement::UnderMouse, Placement::OnMainWindow
...
{
    static const NET::WindowType conv[] = {NET::Normal, NET::Dialog, NET::Utility, NET::Dock,     NET::Toolbar,
                                           NET::Menu,   NET::Splash, NET::Desktop, NET::Override, NET::TopMenu};
    return conv[val];
}
...
void RulesWidget::detected(bool ok)
{
    if(ok)
    {
        ...
        role_match->setCurrentItem(detect_dlg->selectedRole().isEmpty() ? Rules::UnimportantMatch : Rules::ExactMatch);
        roleMatchChanged();
...
RulesDialog::RulesDialog(QWidget *parent, const char *name) : KDialogBase(parent, name, true, i18n("Edit Window-Specific Settings"), Ok | Cancel)
{
...
EditShortcut::EditShortcut(QWidget *parent, const char *name) : EditShortcutBase(parent, name)
{
}
...
EditShortcutDialog::EditShortcutDialog(QWidget *parent, const char *name) : KDialogBase(parent, name, true, i18n("Edit Shortcut"), Ok | Cancel)
{
...
ShortcutDialog::ShortcutDialog(const KShortcut &cut, QWidget *parent, const char *name) : KShortcutDialog(cut, false /*TODO???*/, parent, name)
{
}
