...
int main(int argc, char *argv[])
{
    ...
    QStringList tempSaverFileList = KGlobal::dirs()->findAllResources("scrsav", "*.desktop", false, true);
    ...
    XSetWindowBackground(qt_xdisplay(), win, BlackPixel(qt_xdisplay(), qt_xscreen()));
    XClearWindow(qt_xdisplay(), win);
}


KRandomSetup::KRandomSetup(QWidget *parent, const char *name)
    : KDialogBase(parent, name, true, i18n("Setup Random Screen Saver"), Ok | Cancel, Ok, true)
{
