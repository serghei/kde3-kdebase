...
KateViewSpaceContainer::KateViewSpaceContainer(QWidget *parent, KateViewManager *viewManager)
    : QVBox(parent), m_viewManager(viewManager), m_blockViewCreationAndActivation(false), m_activeViewRunning(false), m_pendingViewCreation(false)
{
    // no memleaks
    ...
    connect(this, SIGNAL(statusChanged(Kate::View *, int, int, int, bool, int, const QString &)), vs,
            SLOT(slotStatusChanged(Kate::View *, int, int, int, bool, int, const QString &)));
    vs->setActive(true);
...
bool KateViewSpaceContainer::createView(Kate::Document *doc)
{
    ...
    activateView(view);
    connect(doc, SIGNAL(modifiedOnDisc(Kate::Document *, bool, unsigned char)), activeViewSpace(),
            SLOT(modifiedOnDisc(Kate::Document *, bool, unsigned char)));
...
void KateViewSpaceContainer::splitViewSpace(KateViewSpace *vs, bool isHoriz, bool atTop)
{
    ...
    connect(this, SIGNAL(statusChanged(Kate::View *, int, int, int, bool, int, const QString &)), vsNew,
            SLOT(slotStatusChanged(Kate::View *, int, int, int, bool, int, const QString &)));
