...
public:
    ...
    GlossaryEntryXRef(const QString &term, const QString &id) : m_term(term), m_id(id)
    {
    }
...
public:
    ...
    GlossaryEntry(const QString &term, const QString &definition, const GlossaryEntryXRef::List &seeAlso)
        : m_term(term), m_definition(definition), m_seeAlso(seeAlso)
    {
    }
