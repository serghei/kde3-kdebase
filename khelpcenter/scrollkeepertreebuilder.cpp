...
ScrollKeeperTreeBuilder::ScrollKeeperTreeBuilder(QObject *parent, const char *name) : QObject(parent, name)
{
    loadConfig();
}
...
NavigatorItem *ScrollKeeperTreeBuilder::build(NavigatorItem *parent, NavigatorItem *after)
{
    ...
    {
        kdDebug(1400) << "Scrollkeeper contents file '" << mContentsList << "' does not exist." << endl;
        return 0;
    }
...
int ScrollKeeperTreeBuilder::insertSection(NavigatorItem *parent, NavigatorItem *after, const QDomNode &sectNode, NavigatorItem *&sectItem)
{
