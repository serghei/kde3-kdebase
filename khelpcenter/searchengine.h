...
public:
    ...
    bool search(QString words, QString method = "and", int matches = 5, QString scope = "");
    ...
    static QString substituteSearchQuery(const QString &query, const QString &identifier, const QStringList &words, int maxResults,
