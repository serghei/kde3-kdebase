...
public:
    SectionItem(QListViewItem *parent, const QString &text) : KListViewItem(parent, text)
    {
        setOpen(false);
    }
...
public:
    EntryItem(SectionItem *parent, const QString &term, const QString &id) : KListViewItem(parent, term), m_id(id)
    {
    }
...
Glossary::Glossary(QWidget *parent) : KListView(parent)
{
    ...
    connect(this, SIGNAL(clicked(QListViewItem *)), this, SLOT(treeItemSelected(QListViewItem *)));
    connect(this, SIGNAL(returnPressed(QListViewItem *)), this, SLOT(treeItemSelected(QListViewItem *)));
...
{
    if(!QFile::exists(m_cacheFile) || m_config->readPathEntry("CachedGlossary") != m_sourceFile
...
void Glossary::rebuildGlossaryCache()
{
    ...
    *meinproc << QString::fromLatin1("--stylesheet") << locate("data", QString::fromLatin1("khelpcenter/glossary.xslt"));
