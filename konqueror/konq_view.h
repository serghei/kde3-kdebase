...
public:
     ...
     */
    KonqView(KonqViewFactory &viewFactory, KonqFrame *viewFrame, KonqMainWindow *mainWindow, const KService::Ptr &service,
             const KTrader::OfferList &partServiceOffers, const KTrader::OfferList &appServiceOffers, const QString &serviceType, bool passiveMode);
     ...
     */
    void openURL(const KURL &url, const QString &locationBarURL, const QString &nameFilter = QString::null, bool tempFile = false);
     ...
     *        @see KonqFactory.
     */
    bool changeViewMode(const QString &serviceType, const QString &serviceName = QString::null, bool forceAutoEmbed = false);
    ...
    {
        return m_lstHistory.at() != ((int)m_lstHistory.count()) - 1;
    }
    ...
    {
        m_lstHistory.at(newPos);
    }

    /**
     * @return the history of this view
     */
    const QPtrList< HistoryEntry > &history()
    {
        return m_lstHistory;
    }
