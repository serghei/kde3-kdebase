...
KonqViewFactory::KonqViewFactory(KLibFactory *factory, const QStringList &args, bool createBrowser)
...
KonqViewFactory KonqFactory::createView(const QString &serviceType, const QString &serviceName, KService::Ptr *serviceImpl,
...
void KonqFactory::getOffers(const QString &serviceType, KTrader::OfferList *partServiceOffers, KTrader::OfferList *appServiceOffers)
{
    if(appServiceOffers)
    {
        *appServiceOffers = KTrader::self()->query(
            serviceType, "Application",
            "DesktopEntryName != 'kfmclient' and DesktopEntryName != 'kfmclient_dir' and DesktopEntryName != 'kfmclient_html'", QString::null);
    }
...
const KAboutData *KonqFactory::aboutData()
{
    ...
    {
        s_aboutData =
            new KAboutData("konqueror", I18N_NOOP("Konqueror"), KONQUEROR_VERSION, I18N_NOOP("Web browser, file manager, ..."),
                           KAboutData::License_GPL, I18N_NOOP("(c) 1999-2005, The Konqueror developers"), 0, I18N_NOOP("http://konqueror.kde.org"));
        ...
        s_aboutData->addAuthor("Wynn Wilkes",
                               I18N_NOOP("developer (Java 2 security manager support,\n and other major improvements to applet support)"),
