...
KonqAboutPageFactory::KonqAboutPageFactory(QObject *parent, const char *name) : KParts::Factory(parent, name)
{
...
KParts::Part *KonqAboutPageFactory::createPartObject(QWidget *parentWidget, const char *widgetName, QObject *parent, const char *name, const char *,
                                                     const QStringList &)
{
...
QString KonqAboutPageFactory::loadFile(const QString &file)
{
    ...
    QString basehref = QString::fromLatin1("<BASE HREF=\"file:") + file.left(file.findRev('/')) + QString::fromLatin1("/\">\n");
    QRegExp reg("<head>");
...
QString KonqAboutPageFactory::launch()
{
    ...
    QString continue_icon_path =
        QApplication::reverseLayout() ? iconloader->iconPath("1leftarrow", KIcon::Small) : iconloader->iconPath("1rightarrow", KIcon::Small);
...
QString KonqAboutPageFactory::intro()
{
    ...
    QString back_icon_path =
        QApplication::reverseLayout() ? iconloader->iconPath("forward", KIcon::Small) : iconloader->iconPath("back", KIcon::Small);
    ...
    res = res.arg(i18n("Conquer your Desktop!"))
              ...
              .arg(i18n("To quickly go to your Home folder press the "
                        " home button <img width='16' height='16' src=\"%1\">.")
                       .arg(gohome_icon_path))
              .arg(i18n("For more detailed documentation on Konqueror click <a href=\"%1\">here</a>.").arg("exec:/khelpcenter"))
              .arg(i18n("<em>Tuning Tip:</em> If you want the Konqueror web browser to start faster,"
                       ...
                       .arg("config:/disable_overview"))
              .arg("<img width='16' height='16' src=\"%1\">")
              .arg(continue_icon_path)
...
QString KonqAboutPageFactory::specs()
{
    ...
    res =
        res.arg(i18n("Conquer your Desktop!"))
            .arg(i18n("Konqueror"))
            .arg(i18n("Conquer your Desktop!"))
            .arg(i18n("Konqueror is your file manager, web browser and universal document viewer."))
            .arg(i18n("Starting Points"))
            ...
            .arg(i18n("Konqueror is designed to embrace and support Internet standards. "
                     ...
                     .arg("http://pyxml.sourceforge.net/topics/xbel/"))
            ...
            .arg(i18n("<A HREF=\"%1\">DOM</A> (Level 1, partially Level 2) based "
                     ...
                     .arg("http://www.w3.org/DOM")
                     .arg("http://www.w3.org/TR/html4/"))
            .arg(i18n("built-in"))
            ...
            .arg(i18n("JavaScript enabled (globally). Configure JavaScript <A HREF=\\\"%1\\\">here</A>.")
                     .arg("exec:/kcmshell khtml_java_js")) // leave the double backslashes here, they are necessary for javascript !
            ...
            .arg(i18n("JDK 1.2.0 (Java 2) compatible VM (<A HREF=\"%1\">Blackdown</A>, <A HREF=\"%2\">IBM</A> or <A HREF=\"%3\">Sun</A>)")
                     .arg("http://www.blackdown.org")
                     .arg("http://www.ibm.com")
                     .arg("http://java.sun.com"))
            .arg(i18n("Enable Java (globally) <A HREF=\"%1\">here</A>.").arg("exec:/kcmshell khtml_java_js")) // TODO Maybe test if Java is enabled ?
            .arg(i18n("Netscape Communicator<SUP>&reg;</SUP> <A HREF=\"%4\">plugins</A> (for viewing <A HREF=\"%1\">Flash<SUP>&reg;</SUP></A>, <A "
                      "HREF=\"%2\">Real<SUP>&reg;</SUP></A>Audio, <A HREF=\"%3\">Real<SUP>&reg;</SUP></A>Video, etc.)")
                     .arg("http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash")
                     .arg("http://www.real.com")
                     .arg("http://www.real.com")
                     .arg("about:plugins"))
            .arg(i18n("built-in"))
...
QString KonqAboutPageFactory::tips()
{
    ...
    KIconLoader *iconloader = KGlobal::iconLoader();
    QString viewmag_icon_path = iconloader->iconPath("viewmag", KIcon::Small);
    QString history_icon_path = iconloader->iconPath("history", KIcon::Small);
    QString openterm_icon_path = iconloader->iconPath("openterm", KIcon::Small);
    QString locationbar_erase_rtl_icon_path = iconloader->iconPath("clear_left", KIcon::Small);
    QString locationbar_erase_icon_path = iconloader->iconPath("locationbar_erase", KIcon::Small);
    QString window_fullscreen_icon_path = iconloader->iconPath("window_fullscreen", KIcon::Small);
    QString view_left_right_icon_path = iconloader->iconPath("view_left_right", KIcon::Small);
    QString continue_icon_path =
        QApplication::reverseLayout() ? iconloader->iconPath("1leftarrow", KIcon::Small) : iconloader->iconPath("1rightarrow", KIcon::Small);
    ...
    res = res.arg(i18n("Conquer your Desktop!"))
              ...
              .arg(i18n("You can also find <img width='16' height='16' src=\"%1\"> \"Full-Screen Mode\" "
                        ...
                        "sessions.")
                       .arg(window_fullscreen_icon_path))
              ...
              .arg(i18n("Advanced users will appreciate the Konsole which you can embed into "
                        ...
                        "Terminal Emulator).")
                       .arg(openterm_icon_path))
              .arg(i18n("Thanks to <a href=\"%1\">DCOP</a> you can have full control over Konqueror using a script.").arg("exec:/kdcop"))
...
KonqAboutPage::KonqAboutPage( // KonqMainWindow *
    QWidget *parentWidget, const char *widgetName, QObject *parent, const char *name)
...
void KonqAboutPage::urlSelected(const QString &url, int button, int state, const QString &target, KParts::URLArgs _args)
{
    ...
    {
        if(KMessageBox::questionYesNo(widget(), i18n("Do you want to disable showing "
