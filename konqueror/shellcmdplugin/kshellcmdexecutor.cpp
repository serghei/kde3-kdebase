...
KShellCommandExecutor::KShellCommandExecutor(const QString &command, QWidget *parent)
    : QTextView(parent), m_shellProcess(0), m_command(command), m_readNotifier(0), m_writeNotifier(0)
{
...
void KShellCommandExecutor::writeDataToShell()
{
    ...
    bool ok;
    QString str = KInputDialog::getText(QString::null, i18n("Input Required:"), QString::null, &ok, this);
    if(ok)
    {
