...
class KonqCheckBox : public QCheckBox {
    Q_OBJECT // for classname
        public : KonqCheckBox(QWidget *parent = 0, const char *name = 0)
...
public:
    ...
    virtual void reparentFrame(QWidget *parent, const QPoint &p, bool showIt = FALSE) = 0;
...
public:
    KonqFrame(QWidget *parent, KonqFrameContainerBase *parentContainer = 0L, const char *name = 0L);
    virtual ~KonqFrame();
...
public:
    ...
    virtual QCString frameType()
    {
        return QCString("ContainerBase");
    }

    virtual void reparentFrame(QWidget *parent, const QPoint &p, bool showIt = FALSE) = 0;

    virtual KonqFrameBase *activeChild()
    {
...
public:
    KonqFrameContainer(Orientation o, QWidget *parent, KonqFrameContainerBase *parentContainer, const char *name = 0);
