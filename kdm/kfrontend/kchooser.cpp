...
public:
    ChooserListViewItem(QListView *parent, int _id, const QString &nam, const QString &sts) : QListViewItem(parent, nam, sts)
    {
        id = _id;
    };
...
ChooserDlg::ChooserDlg() : inherited()
{
...
void ChooserDlg::slotReadPipe()
{
    ...
    switch(cmd)
    {
        ...
        case G_Ch_ChangeHost:
            ...
            if(cmd == G_Ch_AddHost)
                host_view->insertItem(new ChooserListViewItem(host_view, id, nam, sts));
            else
            {
