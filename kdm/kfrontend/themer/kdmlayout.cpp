...
void KdmLayoutFixed::update(const QRect &parentGeometry, bool force)
{
...
QSize KdmLayoutBox::sizeHint()
{
    ...
    return QSize(w < box.minwidth ? box.minwidth : w, h < box.minheight ? box.minheight : h);
}
