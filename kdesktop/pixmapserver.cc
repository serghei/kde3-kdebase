...
KPixmapServer::KPixmapServer() : QWidget(0L, "shpixmap comm window")
{
...
bool KPixmapServer::x11Event(XEvent *event)
{
    ...
    if(event->type == SelectionRequest)
    {
        ...
        XChangeProperty(qt_xdisplay(), ev->requestor, ev->property, pixmap, 32, PropModeReplace, (unsigned char *)&si.handle, 1);
        it2.data().usecount++;
