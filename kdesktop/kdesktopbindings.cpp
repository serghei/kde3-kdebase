...
#define DEF2(name, key3, key4, receiver, slot) keys->insert(name, i18n(name), QString::null, key3, key4, receiver, slot);
#else
#define DEF(name, key3, key4, fnSlot) keys->insert(name, i18n(name), QString::null, key3, key4)
#define DEF2(name, key3, key4, receiver, slot) keys->insert(name, i18n(name), QString::null, key3, key4)
#endif
