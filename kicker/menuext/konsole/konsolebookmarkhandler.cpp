...
KonsoleBookmarkHandler::KonsoleBookmarkHandler(KonsoleMenu *konsole, bool)
    : QObject(konsole, "KonsoleBookmarkHandler"), KBookmarkOwner(), m_konsole(konsole), m_importStream(0L)
{
...
void KonsoleBookmarkHandler::importOldBookmarks(const QString &path, const QString &destinationPath)
{
    ...
    *m_importStream << "<!DOCTYPE xbel>\n<xbel>\n";
    ...
    connect(&importer, SIGNAL(newFolder(const QString &, bool, const QString &)), SLOT(slotNewFolder(const QString &, bool, const QString &)));
...
void KonsoleBookmarkHandler::slotNewBookmark(const QString & /*text*/, const QCString &url, const QString &additionalInfo)
{
...
void KonsoleBookmarkHandler::slotNewFolder(const QString &text, bool /*open*/, const QString & /*additionalInfo*/)
{
