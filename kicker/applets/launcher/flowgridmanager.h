...
public:
    typedef enum { ItemSlack, SpaceSlack, BorderSlack, NoSlack } Slack;

    FlowGridManager(QSize p_item_size = QSize(0, 0), QSize p_space_size = QSize(0, 0), QSize p_border_size = QSize(0, 0),
                    QSize frame_size = QSize(0, 0), Qt::Orientation orient = Qt::Horizontal, int num_items = 0, Slack slack_x = ItemSlack,
