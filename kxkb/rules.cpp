...
XkbRules::XkbRules(bool layoutsOnly) : m_layouts(90)
{
...
{
    return X11Helper::areSingleGroupsSupported() && !m_oldLayouts.contains(layout) && !m_nonLatinLayouts.contains(layout);
}
...
unsigned int XkbRules::getDefaultGroup(const QString &layout, const QString &includeGroup)
{
...
QStringList XkbRules::getAvailableVariants(const QString &layout)
{
