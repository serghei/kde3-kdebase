...
static KCmdLineOptions options[] = {{"!+command", I18N_NOOP("Command to execute"), 0},
...
{
    KAboutData aboutData("ksystraycmd", I18N_NOOP("KSysTrayCmd"), "KSysTrayCmd 0.1",
                         I18N_NOOP("Allows any application to be kept in the system tray"), KAboutData::License_GPL,
