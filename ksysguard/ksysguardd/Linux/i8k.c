...
void initI8k(struct SensorModul *sm)
{
    ...
    registerMonitor("dell/cputemp", "integer", printI8kCPUTemperature, printI8kCPUTemperatureInfo, sm);
    registerMonitor("dell/fan0", "integer", printI8kFan0Speed, printI8kFan0SpeedInfo, sm);
    registerMonitor("dell/fan1", "integer", printI8kFan1Speed, printI8kFan1SpeedInfo, sm);
}
...
int updateI8k(void)
{
    ...
    sscanf(I8kBuf, "%*f %*s %*s %d %*d %*d %d %d %*d %*d", &cpuTemp, &fan0Speed, &fan1Speed);
