...
PrivateListViewItem::PrivateListViewItem(PrivateListView *parent) : QListViewItem(parent)
{
    _parent = parent;
}
...
PrivateListView::PrivateListView(QWidget *parent, const char *name) : QListView(parent, name)
{
...
void PrivateListView::addColumn(const QString &label, const QString &type)
{
    ...
    {
        kdDebug(1215) << "Unknown type " << type << " of column " << label << " in ListView!" << endl;
        return;
    }
...
ListView::ListView(QWidget *parent, const char *name, const QString &title, int, int) : KSGRD::SensorDisplay(parent, name, title)
{
...
bool ListView::addSensor(const QString &hostName, const QString &sensorName, const QString &sensorType, const QString &title)
{
...
void ListView::answerReceived(int id, const QString &answer)
{
...
bool ListView::restoreSettings(QDomElement &element)
{
    addSensor(element.attribute("hostName"), element.attribute("sensorName"),
              (element.attribute("sensorType").isEmpty() ? "listview" : element.attribute("sensorType")), element.attribute("title"));
...
bool ListView::saveSettings(QDomDocument &doc, QDomElement &element, bool save)
{
...
void ListView::configureSettings()
{
