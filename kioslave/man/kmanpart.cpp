...
KManPartFactory::KManPartFactory(QObject *parent, const char *name) : KParts::Factory(parent, name)
{
}
...
KParts::Part *KManPartFactory::createPartObject(QWidget *parentWidget, const char * /*widgetName*/, QObject *, const char *name,
...
KInstance *KManPartFactory::instance()
{
    if(!s_instance)
    {
        s_about = new KAboutData("kmanpart", I18N_NOOP("KMan"), KDE_VERSION_STRING);
...
KManPart::KManPart(QWidget *parent, const char *name) : KHTMLPart(parent, name), m_job(0)
{
