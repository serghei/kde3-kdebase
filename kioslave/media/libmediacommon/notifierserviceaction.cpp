...
NotifierServiceAction::NotifierServiceAction() : NotifierAction()
{
...
void NotifierServiceAction::updateFilePath()
{
    ...
    {
        filename = actions_dir.absFilePath(action_name + QString::number(counter) + ".desktop");
        counter++;
    }
...
void NotifierServiceAction::save() const
{
    ...
    desktopFile.writeEntry(QString("Actions"), QStringList(m_service.m_strName), ";");
}
