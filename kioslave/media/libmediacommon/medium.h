...
public:
    ...
    QString label() const
    {
        return m_properties[LABEL];
    }
    QString userLabel() const
    {
        return m_properties[USER_LABEL];
    }
    bool isMountable() const
    {
        return m_properties[MOUNTABLE] == "true";
    }
    QString deviceNode() const
    {
        return m_properties[DEVICE_NODE];
    }
    QString mountPoint() const
    {
        return m_properties[MOUNT_POINT];
    }
    QString fsType() const
    {
        return m_properties[FS_TYPE];
    }
    bool isMounted() const
    {
        return m_properties[MOUNTED] == "true";
    }
    QString baseURL() const
    {
        return m_properties[BASE_URL];
    }
    QString mimeType() const
    {
        return m_properties[MIME_TYPE];
    }
    QString iconName() const
    {
        return m_properties[ICON_NAME];
    }
    ...
    void mountableState(const QString &deviceNode, const QString &mountPoint, const QString &fsType, bool mounted);
    void unmountableState(const QString &baseURL = QString::null);

    void setMimeType(const QString &mimeType);
    void setIconName(const QString &iconName);
    void setHalMounted(bool flag) const
    {
        m_halmounted = flag;
    }
    bool halMounted() const
    {
        return m_halmounted;
    }
