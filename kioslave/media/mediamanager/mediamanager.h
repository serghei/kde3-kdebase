...
public:
    ...
    k_dcop_signals : void mediumAdded(const QString &name, bool allowNotification);
...
private slots:
    ...
    void slotMediumAdded(const QString &id, const QString &name, bool allowNotification);
    void slotMediumRemoved(const QString &id, const QString &name, bool allowNotification);
    void slotMediumChanged(const QString &id, const QString &name, bool mounted, bool allowNotification);
