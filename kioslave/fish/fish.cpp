...
#define connected()                                                                                                                                  \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting connected()" << endl);                                                                                          \
        connected();                                                                                                                                 \
    } while(0)
#define dataReq()                                                                                                                                    \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting dataReq()" << endl);                                                                                            \
        dataReq();                                                                                                                                   \
    } while(0)
#define needSubURLData()                                                                                                                             \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting needSubURLData()" << endl);                                                                                     \
        needSubURLData();                                                                                                                            \
    } while(0)
#define slaveStatus(x, y)                                                                                                                            \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting slaveStatus(" << x << ", " << y << ")" << endl);                                                                \
        slaveStatus(x, y);                                                                                                                           \
    } while(0)
#define statEntry(x)                                                                                                                                 \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting statEntry(" << x.size() << ")" << endl);                                                                        \
        statEntry(x);                                                                                                                                \
    } while(0)
#define listEntries(x)                                                                                                                               \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting listEntries(...)" << endl);                                                                                     \
        listEntries(x);                                                                                                                              \
    } while(0)
#define canResume(x)                                                                                                                                 \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting canResume(" << (int)x << ")" << endl);                                                                          \
        canResume(x);                                                                                                                                \
    } while(0)
#define totalSize(x)                                                                                                                                 \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting totalSize(" << (int)x << ")" << endl);                                                                          \
        totalSize(x);                                                                                                                                \
    } while(0)
#define processedSize(x)                                                                                                                             \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting processedSize(" << x << ")" << endl);                                                                           \
        processedSize(x);                                                                                                                            \
    } while(0)
#define speed(x)                                                                                                                                     \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting speed(" << (int)x << ")" << endl);                                                                              \
        speed(x);                                                                                                                                    \
    } while(0)
#define redirection(x)                                                                                                                               \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting redirection(" << x << ")" << endl);                                                                             \
        redirection(x);                                                                                                                              \
    } while(0)
#define errorPage()                                                                                                                                  \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting errorPage()" << endl);                                                                                          \
        errorPage();                                                                                                                                 \
    } while(0)
#define sendmimeType(x)                                                                                                                              \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting mimeType(" << x << ")" << endl);                                                                                \
        mimeType(x);                                                                                                                                 \
    } while(0)
#define warning(x)                                                                                                                                   \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting warning(" << x << ")" << endl);                                                                                 \
        warning(x);                                                                                                                                  \
    } while(0)
#define infoMessage(x)                                                                                                                               \
    do                                                                                                                                               \
    {                                                                                                                                                \
        myDebug(<< "_______ emitting infoMessage(" << x << ")" << endl);                                                                             \
        infoMessage(x);                                                                                                                              \
    } while(0)
#else
#define myDebug(x)
...
const struct fishProtocol::fish_info fishProtocol::fishInfo[] = {
    {("FISH"), 0, ("echo; /bin/sh -c start_fish_server > /dev/null 2>/dev/null; perl .fishsrv.pl " CHECKSUM
                   " 2>/dev/null; perl -e '$|=1; print \"### 100 transfer fish server\\n\"; while(<STDIN>) { last if /^__END__/; $code.=$_; } "
                   "exit(eval($code));' 2>/dev/null;"),
     1},
    {("VER 0.0.3 copy append lscount lslinks lsmime exec stat"), 0, ("echo 'VER 0.0.3 copy append lscount lslinks lsmime exec stat'"), 1},
    {("PWD"), 0, ("pwd"), 1},
    {("LIST"), 1,
     ("echo `ls -Lla %1 2> /dev/null | grep '^[-dsplcb]' | wc -l`; ls -Lla %1 2>/dev/null | grep '^[-dspl]' | ( while read -r p x u g s m d y n; do "
      "file -b -i $n 2>/dev/null | sed -e '\\,^[^/]*$,d;s/^/M/;s,/.*[ \t],/,'; FILE=%1; if [ -e %1\"/$n\" ]; then FILE=%1\"/$n\"; fi; if [ -L "
      "\"$FILE\" ]; then echo \":$n\"; ls -lad \"$FILE\" | sed -e 's/.* -> /L/'; else echo \":$n\" | sed -e 's/ -> /\\\nL/'; fi; echo \"P$p "
      "$u.$g\nS$s\nd$m $d $y\n\"; done; );"
      "ls -Lla %1 2>/dev/null | grep '^[cb]' | ( while read -r p x u g a i m d y n; do echo \"P$p $u.$g\nE$a$i\nd$m $d $y\n:$n\n\"; done; )"),
     0},
    {("STAT"), 1,
     ("echo `ls -dLla %1 2> /dev/null | grep '^[-dsplcb]' | wc -l`; ls -dLla %1 2>/dev/null | grep '^[-dspl]' | ( while read -r p x u g s m d y n; "
      "do file -b -i $n 2>/dev/null | sed -e '\\,^[^/]*$,d;s/^/M/;s,/.*[ \t],/,'; FILE=%1; if [ -e %1\"/$n\" ]; then FILE=%1\"/$n\"; fi; if [ -L "
      "\"$FILE\" ]; then echo \":$n\"; ls -lad \"$FILE\" | sed -e 's/.* -> /L/'; else echo \":$n\" | sed -e 's/ -> /\\\nL/'; fi; echo \"P$p "
      "$u.$g\nS$s\nd$m $d $y\n\"; done; );"
    ...
    {("CHOWN"), 2, ("chown %1 %2"), 0},
    {("CHGRP"), 2, ("chgrp %1 %2"), 0},
    {("READ"), 3, ("echo '### 100';cat %3 /dev/zero | ( [ \"`expr %1 / 4096`\" -gt 0 ] && dd bs=4096 count=`expr %1 / 4096` >/dev/null;"
    ...
    // we use APPEND.
    {("WRITE"), 3, (">> %3; echo '### 001'; ( [ %2 -gt 0 ] && dd ibs=1 obs=%2 count=%2 2>/dev/null ) | "
                    "( dd ibs=32768 obs=%1 seek=1 of=%3 2>/dev/null || echo Error $?; cat >/dev/null; )"),
     0},
    {("COPY"), 2,
     ("if [ -L %1 ]; then if cp -pdf %1 %2 2>/dev/null; then :; else LINK=\"`readlink %1`\"; ln -sf $LINK %2; fi; else cp -pf %1 %2; fi"), 0},
    {("APPEND"), 2,
     (">> %2; echo '### 001'; ( [ %1 -gt 0 ] && dd ibs=1 obs=%1 count=%1 2> /dev/null; ) | ( cat >> %2 || echo Error $?; cat >/dev/null; )"), 0},
...
fishProtocol::fishProtocol(const QCString &pool_socket, const QCString &app_socket)
    : SlaveBase("fish", pool_socket, app_socket), mimeBuffer(1024), mimeTypeSent(false)
{
...
bool fishProtocol::connectionStart()
{
    ...
    if(childPid == 0)
    {
        ...
        if(local)
        {
            execl(suPath, "su", "-", connectionUser.latin1(), "-c",
                  "cd ~;echo FISH:;exec /bin/sh -c \"if env true 2>/dev/null; then env PS1= PS2= TZ=UTC LANG=C LC_ALL=C LOCALE=C /bin/sh; else PS1= "
                  "PS2= TZ=UTC LANG=C LC_ALL=C LOCALE=C /bin/sh; fi\"",
                  (void *)0);
        }
        else
        {
#define common_args                                                                                                                                  \
    "-l", connectionUser.latin1(), "-x", "-e", "none", "-q", connectionHost.latin1(),                                                                \
        "echo FISH:;exec /bin/sh -c \"if env true 2>/dev/null; then env PS1= PS2= TZ=UTC LANG=C LC_ALL=C LOCALE=C /bin/sh; else PS1= PS2= TZ=UTC "   \
        "LANG=C LC_ALL=C LOCALE=C /bin/sh; fi\"",                                                                                                    \
        (void *)0
...
bool fishProtocol::sendCommand(fish_command_type cmd, ...)
{
    ...
    myDebug(<< "queueing: cmd=" << cmd << "['" << info.command << "'](" << info.params << "), alt=['" << info.alt << "'], lines=" << info.lines
            << endl);
                    ...
                    switch(line[0].cell())
                    {
                        ...
                        case 'D':
                            ...
                            if(pos < 0 || pos2 < 0 || pos3 < 0)
                                break;
                            dt.setDate(QDate(line.mid(1, pos - 1).toInt(), line.mid(pos + 1, pos2 - pos - 1).toInt(),
                                             line.mid(pos2 + 1, pos3 - pos2 - 1).toInt()));
                            pos = pos3;
                            pos2 = line.find(' ', pos + 1);
                            pos3 = line.find(' ', pos2 + 1);
                            if(pos < 0 || pos2 < 0 || pos3 < 0)
                                break;
                            dt.setTime(QTime(line.mid(pos + 1, pos2 - pos - 1).toInt(), line.mid(pos2 + 1, pos3 - pos2 - 1).toInt(),
                                             line.mid(pos3 + 1).toInt()));
                            errorCount--;
                        ...
                        case 'M':
                        {
                            ...
                            // guesses, so we must try to ignore them (#51274)
                                    ...
                                    && (thisFn.find('.') < 0 || (line.left(8) != "Mtext/x-" && line != "Mtext/plain")))
                            {
                                mimeAtom.m_str = type;
                            }
                            errorCount--;
