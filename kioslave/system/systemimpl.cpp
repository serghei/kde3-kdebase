...
{
    KGlobal::dirs()->addResourceType("system_entries", KStandardDirs::kde_default("data") + "systemview");
}
...
bool SystemImpl::realURL(const QString &name, const QString &path, KURL &url) const
{
...
void SystemImpl::createEntry(KIO::UDSEntry &entry, const QString &directory, const QString &file)
{
