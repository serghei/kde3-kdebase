    ...
    : KPasswordDialog(Password, enableKeep, (withIgnoreButton ? User1 : NoDefault), icon)
{
    ...
    else
    {
        ...
        {
            prompt = i18n(
                         "The action you requested needs additional privileges. "
...
bool KDEsuDialog::checkPassword(const char *password)
{
    ...
    switch(status)
    {
        ...
        case SuProcess::SuNotFound:
            KMessageBox::sorry(this, i18n("The program 'su' is not found;\n"
                                          "make sure your PATH is set correctly."));
            done(Rejected);
            return false;

        case SuProcess::SuNotAllowed:
            KMessageBox::sorry(this, i18n("You are not allowed to use 'su';\n"
