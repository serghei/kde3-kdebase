...
static struct pam_conv PAM_conversation = {&PAM_conv, &PAM_data};
...
AuthReturn Authenticate(const char *caller, const char *method, const char *user, char *(*conv)(ConvRequest, const char *))
{
    const char *tty;
    pam_handle_t *pamh;
