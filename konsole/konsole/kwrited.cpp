...
QPopupMenu *KWrited::createPopupMenu(const QPoint &pos)
{
    ...
    menu->insertItem(i18n("Clear Messages"), this, SLOT(clearText()), 0, -1, 0);

    return menu;
}

KWritedModule::KWritedModule(const QCString &obj) : KDEDModule(obj)
{
...
extern "C" KDE_EXPORT KDEDModule *create_kwrited(const QCString &obj)
{
