...
public:
    TESession(TEWidget *w, const QString &term, ulong winId, const QString &sessionId = "session-1", const QString &initial_cwd = QString::null);
    ...
    QString getPgm();
    QString getCwd();
    QString getInitial_cwd()
    {
        return initial_cwd;
    }
    void setInitial_cwd(const QString &_cwd)
    {
        initial_cwd = _cwd;
    }
