...
public:
    ...
    {
        cuttobeginningofline = enable;
    }
    bool cutToBeginningOfLine()
    {
        return cuttobeginningofline;
    }
    ...
    void setLineWrapped(QBitArray line_wrapped)
    {
    ...
    {
        return terminalSizeHint;
    }
    void setTerminalSizeStartup(bool on)
    {
        terminalSizeStartup = on;
    }
...
protected:
    ...
    void drawTextFixed(QPainter &paint, int x, int y, QString &str, const ca *attr);

    void drawAttrStr(QPainter &paint, QRect rect, QString &str, const ca *attr, bool pm, bool clear);
