...
public:
    Desktop(int desk, QString desktopName, QWidget *parent = 0, const char *name = 0);
    ~Desktop();
...
protected:
    ...
    void paintWindow(QPainter &p, const KWin::WindowInfo *info, bool onDesktop = true);
    void paintWindowPlain(QPainter &p, const KWin::WindowInfo *info, bool onDesktop = true);
    void paintWindowIcon(QPainter &p, const KWin::WindowInfo *info, bool onDesktop = true);
    void paintWindowPixmap(QPainter &p, const KWin::WindowInfo *info, bool onDesktop = true);
