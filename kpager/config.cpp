...
KPagerConfigDialog::KPagerConfigDialog(QWidget *parent) : KDialogBase(parent, "configdialog", true, i18n("Configuration"), Ok | Cancel, Ok, true)
{
    ...
    QVBoxLayout *vbox = new QVBoxLayout(m_grpWindowDrawMode, KDialog::marginHint(), KDialog::spacingHint());
