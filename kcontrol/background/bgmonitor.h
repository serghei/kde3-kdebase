...
public:
    ...
    QSize combinedPreviewSize() const
    {
        return m_combinedPreviewSize;
    }
    QSize maxPreviewSize() const
    {
        return m_maxPreviewSize;
    }
    unsigned numMonitors() const
    {
        return m_pBGMonitor.size();
    }
...
public:
    ...
    BGMonitor *monitor() const
    {
        return m_pBGMonitor;
    }
    void updateMonitorGeometry();

    void setPreviewPosition(QRect r)
    {
        m_previewPosition = r;
    }
    QRect previewPosition() const
    {
