...
BGMonitorArrangement::BGMonitorArrangement(QWidget *parent, const char *name) : QWidget(parent, name)
{
...
void BGMonitorArrangement::updateArrangement()
{
    ...
    double scale = QMIN(double(width()) / double(expandedOverallGeometry.width()), double(height()) / double(expandedOverallGeometry.height()));
...
BGMonitorLabel::BGMonitorLabel(QWidget *parent, const char *name) : QLabel(parent, name)
{
...
BGMonitor::BGMonitor(QWidget *parent, const char *name) : QLabel(parent, name)
{
    setAlignment(AlignCenter);
    setScaledContents(true);
    setAcceptDrops(true);
