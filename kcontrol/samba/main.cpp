    ...
    , statisticsView(&tabs, &config)
{
    ...
    setQuickHelp(
        i18n("The Samba and NFS Status Monitor is a front end to the programs"
    ...
    KAboutData *about = new KAboutData(I18N_NOOP("kcmsamba"), I18N_NOOP("KDE Panel System Information Control Module"), 0, 0, KAboutData::License_GPL,
