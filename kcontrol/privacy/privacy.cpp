...
Privacy::Privacy(QWidget *parent, const char *name) : KCModule(parent, name)
{
    setQuickHelp(
        i18n("The privacy module allows a user to erase traces which KDE leaves on "
             "the system, such as command histories or browser caches."));

    setButtons(KCModule::Default | KCModule::Apply | KCModule::Help);

    KAboutData *about = new KAboutData(I18N_NOOP("kcm_privacy"), I18N_NOOP("KDE Privacy Control Module"), 0, 0, KAboutData::License_GPL,
    ...
    clearThumbnails = new QCheckListItem(generalCLI, i18n("Thumbnail Cache"), QCheckListItem::CheckBox);
    clearRunCommandHistory = new QCheckListItem(generalCLI, i18n("Run Command History"), QCheckListItem::CheckBox);
    clearAllCookies = new QCheckListItem(webbrowsingCLI, i18n("Cookies"), QCheckListItem::CheckBox);
    clearSavedClipboardContents = new QCheckListItem(generalCLI, i18n("Saved Clipboard Contents"), QCheckListItem::CheckBox);
    clearWebHistory = new QCheckListItem(webbrowsingCLI, i18n("Web History"), QCheckListItem::CheckBox);
    clearWebCache = new QCheckListItem(webbrowsingCLI, i18n("Web Cache"), QCheckListItem::CheckBox);
    clearFormCompletion = new QCheckListItem(webbrowsingCLI, i18n("Form Completion Entries"), QCheckListItem::CheckBox);
    clearRecentDocuments = new QCheckListItem(generalCLI, i18n("Recent Documents"), QCheckListItem::CheckBox);
    clearQuickStartMenu = new QCheckListItem(generalCLI, i18n("Quick Start Menu"), QCheckListItem::CheckBox);
    clearFavIcons = new QCheckListItem(webbrowsingCLI, i18n("Favorite Icons"), QCheckListItem::CheckBox);
...
{
    if(KMessageBox::warningContinueCancel(this, i18n("You are deleting data that is potentially valuable to you. Are you sure?"))
