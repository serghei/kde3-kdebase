...
private:
    ...
    bool ram_colors_initialized, swap_colors_initialized, all_colors_initialized;
    ...
    bool Display_Graph(int widgetindex, int count, t_memsize total, t_memsize *used, QColor *color, QString *text);
public slots:
    void update_Values();
};
