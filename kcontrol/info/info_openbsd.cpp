...
bool GetInfo_CPU(QListView *lBox)
{
    static hw_info_mib_list_t hw_info_mib_list[] = {
        {1, HW_MODEL, "Model"}, {1, HW_MACHINE, "Machine"}, {0, HW_NCPU, "Number of CPUs"}, {0, HW_PAGESIZE, "Pagesize"}, {0, 0, 0}};
...
// on system
static bool GetDmesgInfo(QListView *lBox, const char *filter, void func(QListView *, QString s, void **, bool))
{
...
bool GetInfo_Partitions(QListView *lbox)
{
    ...
    while(!(s = t->readLine()).isNull())
    {
        ...
        olditem = new QListViewItem(lbox, olditem, device, mountpoint, type, flags);
