...
Konqueror::Konqueror(QWidget *parent_P) : Konqueror_ui(parent_P)
{
    QWhatsThis::add(rb_never_reuse, i18n("Disables the minimization of memory usage and allows you "
                                         "to make each browsing activity independent from the others"));
    QWhatsThis::add(rb_file_browsing_reuse, i18n("With this option activated, only one instance of Konqueror "
    ...
    QWhatsThis::add(rb_always_reuse, i18n("With this option activated, only one instance of Konqueror "
    ...
    QString tmp = i18n(
        "If non-zero, this option allows keeping Konqueror instances "
    ...
    QWhatsThis::add(cb_preload_on_startup, i18n("If enabled, an instance of Konqueror will be preloaded after the ordinary KDE "
                                                "startup sequence."
    ...
    QWhatsThis::add(cb_always_have_preloaded, i18n("If enabled, KDE will always try to have one preloaded Konqueror instance ready; "
