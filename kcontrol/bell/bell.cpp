...
KDE_EXPORT void init_bell()
{
    ...
    XChangeKeyboardControl(kapp->getDisplay(), KBBellPercent | KBBellPitch | KBBellDuration, &kbdc);
}
}

KBellConfig::KBellConfig(QWidget *parent, const char *name) : KCModule(parent, name)
{
    ...
    setQuickHelp(
        i18n("<h1>System Bell</h1> Here you can customize the sound of the standard system bell,"
    ...
    KAboutData *about = new KAboutData(I18N_NOOP("kcmbell"), I18N_NOOP("KDE Bell Control Module"), 0, 0, KAboutData::License_GPL,
...
void KBellConfig::save()
{
    ...
    XChangeKeyboardControl(kapp->getDisplay(), KBBellPercent | KBBellPitch | KBBellDuration, &kbd);
