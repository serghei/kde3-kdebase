...
KLocaleSample::KLocaleSample(KLocale *locale, QWidget *parent, const char *name) : QWidget(parent, name), m_locale(locale)
{
...
{
    m_numberSample->setText(m_locale->formatNumber(1234567.89) + QString::fromLatin1(" / ") + m_locale->formatNumber(-1234567.89));

    m_moneySample->setText(m_locale->formatMoney(123456789.00) + QString::fromLatin1(" / ") + m_locale->formatMoney(-123456789.00));
    ...
    str = m_locale->translate(
        "This is how date values will be displayed using "
        "a short notation.");
