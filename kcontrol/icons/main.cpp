...
IconModule::IconModule(QWidget *parent, const char *name, const QStringList &) : KCModule(IconsFactory::instance(), parent, name)
{
    ...
    KAboutData *about = new KAboutData("kcmicons", I18N_NOOP("Icons"), "3.0", I18N_NOOP("Icons Control Panel Module"), KAboutData::License_GPL,
...
QString IconModule::quickHelp() const
{
    return i18n(
        ...
        "To choose an icon theme, click on its name and apply your choice by pressing the \"Apply\" button below. If you do not want to apply your "
        "choice you can press the \"Reset\" button to discard your changes.</p>"
        "<p>By pressing the \"Install New Theme\" button you can install your new icon theme by writing its location in the box or browsing to the "
        "location."
