...
public:
    ...
    static IndexViewMode viewMode()
    {
        return _viewmode;
    }
    static KIcon::StdSizes iconSize()
    {
        return _iconsize;
    }
    static QString baseGroup();

    static void setIsInfoCenter(bool b)
    {
        _infocenter = b;
    }
    ...
    static void setViewMode(IndexViewMode m)
    {
        _viewmode = m;
    }
    static void setIconSize(KIcon::StdSizes s)
    {
        _iconsize = s;
    }
