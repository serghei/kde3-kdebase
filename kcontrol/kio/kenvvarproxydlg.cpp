...
KEnvVarProxyDlg::KEnvVarProxyDlg(QWidget *parent, const char *name) : KProxyDialogBase(parent, name, true, i18n("Variable Proxy Configuration"))
{
...
void KEnvVarProxyDlg::verifyPressed()
{
    ...
    {
        QString msg = i18n(
            "You must specify at least one valid proxy "
            "environment variable.");

        QString details = i18n(
            "<qt>Make sure you entered the actual environment "
        ...
        KMessageBox::detailedSorry(this, msg, details, i18n("Invalid Proxy Setup"));
    }
    else
    {
        KMessageBox::information(this, i18n("Successfully verified."), i18n("Proxy Setup"));
    }
}
...
void KEnvVarProxyDlg::slotOk()
{
    if(!validate(true))
    {
        ...
        KMessageBox::detailedError(this, msg, details, i18n("Invalid Proxy Setup"));
        return;
    }
