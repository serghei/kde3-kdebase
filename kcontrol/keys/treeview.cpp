...
AppTreeItem::AppTreeItem(QListViewItem *parent, const QString &storageId) : KListViewItem(parent), m_init(false), m_storageId(storageId)
{
}
...
AppTreeItem::AppTreeItem(QListView *parent, const QString &storageId) : KListViewItem(parent), m_init(false), m_storageId(storageId)
{
}
...
AppTreeView::AppTreeView(QWidget *parent, const char *name) : KListView(parent, name)
{
