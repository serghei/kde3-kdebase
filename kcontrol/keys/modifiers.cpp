...
ModifiersModule::ModifiersModule(QWidget *parent, const char *name) : QWidget(parent, name)
{
    initGUI();
    load(false);
}
...
void ModifiersModule::initGUI()
{
    ...
    QWhatsThis::add(m_pchkMacSwap, i18n("Checking this box will change your X Modifier Mapping to "
...
void ModifiersModule::slotMacSwapClicked()
{
    ...
    {
        KMessageBox::sorry(this, i18n("You can only activate this option if your "
