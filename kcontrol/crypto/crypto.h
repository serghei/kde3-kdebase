...
public:
    CipherItem(QListView *view, const QString &cipher, int bits, int maxBits, KCryptoConfig *module);
    ~CipherItem()
    {
    }
...
public:
    ...
    void setPermanent(bool x)
    {
        _perm = x;
    }
    void setExpires(QDateTime x)
    {
        _exp = x;
    }
...
public:
    ...
    QString &getPassCache()
    {
        return _cpass;
    }
    void setPassCache(QString pass)
    {
        _cpass = pass;
    }
...
public:
    ...
    inline QString getCert() const
    {
        return _cert;
    }
    inline bool getSite() const
    {
        return _site;
    }
    inline bool getEmail() const
    {
        return _email;
    }
    inline bool getCode() const
    {
        return _code;
    }
    inline void setSite(bool x)
    {
        _site = x;
    }
    inline void setEmail(bool x)
    {
        _email = x;
    }
    inline void setCode(bool x)
    {
        _code = x;
    }
...
public:
    ...
    KSSLCertificateHome::KSSLAuthAction getAction() const
    {
        return _aa;
    }
    QString configName() const
    ...
    QString getCertName() const
    {
        return _name;
    }
    void setCertName(QString name)
    {
        _name = name;
        setText(1, name);
    }
    ...
    void setOriginalName(QString oname)
    {
        _oname = oname;
    }
...
private:
    ...
    QPushButton *yourSSLImport, *yourSSLPass, *yourSSLRemove, *yourSSLExport, *yourSSLUnlock, *yourSSLVerify;
