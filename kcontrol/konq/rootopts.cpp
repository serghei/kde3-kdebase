...
DesktopPathConfig::DesktopPathConfig(QWidget *parent, const char *) : KCModule(parent, "kcmkonq")
{
    QLabel *tmpLabel;
...
#define RO_LASTCOL 2
    ...
    int row = 0;
    QGridLayout *lay = new QGridLayout(this, RO_LASTROW + 1, RO_LASTCOL + 1, 0, KDialog::spacingHint());
    ...
    wtstr = i18n(
        "This folder contains applications or"
    ...
    wtstr = i18n(
        "This folder will be used by default to "
...
bool DesktopPathConfig::moveDir(const KURL &src, const KURL &dest, const QString &type)
{
    ...
    if(KMessageBox::questionYesNo(this, i18n("The path for '%1' has been changed;\ndo you want the files to be moved from '%2' to '%3'?")
                                            ...
                                            .arg(src.path())
                                            .arg(dest.path()),
                                  i18n("Confirmation Required"), i18n("Move"), KStdGuiItem::cancel())
       == KMessageBox::Yes)
    {
