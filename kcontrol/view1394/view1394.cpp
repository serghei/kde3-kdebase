...
View1394::View1394(QWidget *parent, const char *name) : KCModule(parent, name), m_insideRescanBus(false)
{
    setQuickHelp(
        i18n("On the right hand side you can see some information about "
