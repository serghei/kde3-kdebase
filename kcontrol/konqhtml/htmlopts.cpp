    ...
    : KCModule(parent, "kcmkonqhtml"), m_pConfig(config), m_groupname(group)
{
    ...
    // Bookmarks
    setQuickHelp(
        i18n("<h1>Konqueror Browser</h1> Here you can configure Konqueror's browser "
    ...
    QWhatsThis::add(m_pAdvancedAddBookmarkCheckBox,
                    i18n("If this box is checked, Konqueror will allow you to"
    ...
    QWhatsThis::add(m_pOnlyMarkedBookmarksCheckBox,
                    i18n("If this box is checked, Konqueror will show only those"
    ...
    QWhatsThis::add(m_pDynamicTabbarHide,
                    i18n("This will display the tab bar only if there are two or more tabs. Otherwise it will always be displayed."));
    ...
    QWhatsThis::add(m_pOpenMiddleClick, i18n("If this box is checked, you can open the URL in the selection by middle clicking on a "
                                             "Konqueror view."));
    ...
    QWhatsThis::add(m_pBackRightClick, i18n("If this box is checked, you can go back in history by right clicking on a Konqueror view. "
    ...
    QWhatsThis::add(m_pAutoLoadImagesCheckBox,
                    i18n("If this box is checked, Konqueror will automatically load any images that are embedded in a web page. Otherwise, it will "
                         "display placeholders for the images, and you can then manually load the images by clicking on the image button.<br>Unless "
    ...
    QWhatsThis::add(m_pUnfinishedImageFrameCheckBox,
                    i18n("If this box is checked, Konqueror will draw a frame as placeholder around not yet fully loaded images that are embedded in "
                         "a web page.<br>Especially if you have a slow network connection, you will probably want to check this box to enhance your "
                         "browsing experience."));
    ...
    QWhatsThis::add(m_pAutoRedirectCheckBox, i18n("Some web pages request an automatic reload or redirection after a certain period of time. By "
                                                  "unchecking this box Konqueror will ignore these requests."));
    ...
    row++;
    whatsThis = i18n(
        "Controls how Konqueror shows animated images:<br>"
