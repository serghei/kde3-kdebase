...
KJSParts::KJSParts(KConfig *config, QWidget *parent, const char *name) : KCModule(parent, name), mConfig(config)
{
    KAboutData *about = new KAboutData(I18N_NOOP("kcmkonqhtml"), I18N_NOOP("Konqueror Browsing Control Module"), 0, 0, KAboutData::License_GPL,
...
void KJSParts::save()
{
    ...
    if(javascript->_removeJavaScriptDomainAdvice || java->_removeJavaScriptDomainAdvice)
    {
